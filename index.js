 ...
 $(document).ready(function(){
  ...
  buttonSlot.addEventListener('click', function(event) {
      ...
      $('.game').effect('shake',{times:1}, 200);

    /*  $('spotTwo').effect('shake', {times:15},200);
      $('spotThree').effect('explode', {times:15},200);
      $('spotFour').effect('explode', {times:15},200);
      $('spotFive').effect('explode', {times:15},200);
      $('spotSix').effect('explode', {times:15},200);
      $('spotSeven').effect('explode', {times:15},200);
      $('spotEight').effect('explode', {times:15},200);
      $('spotNine').effect('explode', {times:15},200);
 */
